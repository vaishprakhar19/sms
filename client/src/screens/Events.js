...
const Events = () => {
  ...
  const fetchEvents = () => {
    axios.get("https://biasportalback.vercel.app/events/")
      .then(response => {
  ...
  const handleAddEvent = (e) => {
    ...
    axios.post("https://biasportalback.vercel.app/events/", transformedEvent)
      .then(response => {
  ...
  const handleDeleteEvent = (eventId) => {
    axios.delete(`https://biasportalback.vercel.app/events/${eventId}`)
      .then(() => {
